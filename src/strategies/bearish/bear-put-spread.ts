...
const bearPutSpread: Strategy = {
  ...
  detailedAnalysis: {
    explanation: `
        ...
        <div class="grid md:grid-cols-3 gap-4 mb-6">
          <div class="bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-lg p-4">
            ...
            <div class="text-lg font-bold text-emerald-700 mb-2">(A − B) − 成本</div>
          ...
          <div class="bg-gradient-to-br from-red-50 to-rose-50 border border-red-200 rounded-lg p-4">
            ...
            <p class="text-xs text-slate-600">若到期价未跌破 A（即 P≥$100k），两腿 Put 均到期归零，损失全部净成本 $3k。</p>
          </div>
    ...
    cons: [
      ...
      '双腿成本：相比单买 Put 多一条卖出腿，开/平仓需承担额外点差与手续费，且 IV 极低时卖出腿权利金过薄、对成本的抵消作用有限。'
    ]
  },
  plainSummary: '你赌 BTC 接下来会往下走一段、但不会崩盘。比直接押它下跌要省钱，代价是真跌穿了头，你赚的也只到事先说好的那个上限为止。',
  analogy: {
    emoji: '🏷️',
    title: '赌降价，但只赌中间一段',
    text: '好比押注某样东西会降价：从 $100k 降到 $90k 这一段，每跌一点你都拿奖金；可一旦跌破 $90k，再怎么暴跌奖金也封顶、不再多给。换来的好处是——这种"只赌一段"的下注，比"赌它无底洞般狂跌"便宜得多。'
  },
  pitfalls: [
    '以为"只要跌就赚"：实际要等价格跌破盈亏平衡点（约 $97k）才真盈利，小跌一点仍在亏掉净成本。',
    '指望靠它吃暴跌：收益在低行权价（$90k）就封顶了，真想赌崩盘该直接买 Put，而不是用价差。',
    '到期日选太短：方向看对了，但行情还没走到目标，时间损耗就先把仓位磨没了。'
  ],
  quickJudge: {
    use: '看温和下跌、想压低成本',
    avoid: '横盘、看涨或赌暴跌时'
