...
const nakedCall: Strategy = {
  ...
  plainSummary: '赌 BTC 不会大涨，现在先收一笔钱。猜对了横盘或下跌就白赚这笔钱；可一旦猜错、价格暴涨，你的亏损没有上限——这是新手千万别碰的策略。',
  analogy: {
    emoji: '🎟️',
    title: '提前卖掉你手里根本没有的东西',
    text: '就像你拍胸脯答应"不管 BTC 涨到多少，我都按 11 万卖给你"，可你手里一个币都没有。它真冲到 20 万，你得先花 20 万买回来、再按 11 万卖出，差价全自己赔——涨得越高赔得越多，亏损没有上限。'
  },
  pitfalls: [
    '被"高胜率"迷惑：连赢十次每次只收 2% 权利金，一次牛市启动就可能全亏回去、还倒贴本金。',
    '以为"+15% 远 OTM 就安全"：BTC 单日 ±15% 是家常便饭，远虚值在加密市场根本不等于安全垫。',
    '不留保证金缓冲：上涨时保证金占用激增，账户往往会在最糟的价位被交易所强制平仓。'
  ],
  quickJudge: {
    use: '坚定看跌横盘、仓位极小、有风控',
    avoid: '牛市/可能暴涨；新手一律别碰'
  },
  greeks: {
    delta: '−',
    gamma: '−',
  ...
  cryptoNote: '在 Deribit 裸卖 Call 会占用保证金，且到期前就可能被增量强平——哪怕现货没动，IV 单独飙升也会推高空头 mark price 触发追保；币本位下暴涨更是"浮亏 + 抵押品缩水"双杀。别迷信"+15% 远 OTM 安全"，BTC 单日 ±15% 是常态，牛市一启动裸卖 Call 就是账户杀手。务必仓位极小、留足保证金缓冲。'
};
