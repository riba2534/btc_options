...
const bearCallSpread: Strategy = {
  ...
  plainSummary: '赌 BTC 短期涨不动。你先收一笔钱，只要币价别冲破上方那道线，这笔钱就稳稳揣兜里；万一真暴涨了，亏损也被提前封顶，不会像裸卖看涨那样变成无底洞。',
  analogy: {
    emoji: '🚧',
    title: '设个天花板收租，再给亏损上保险',
    text: '好比你开个小赌局，押「BTC 半年内涨不过 $105k」，先把别人的赌注（权利金）收下；同时又花点小钱买了份「涨过 $115k 就赔我」的保险。猜对了赌注白赚，猜错了暴涨也有保险兜底，亏损被钉死在固定数额上，不会倾家荡产。',
  },
  pitfalls: [
    '被「高胜率」迷惑：这是赢面大、赔率差的策略，最大亏损 $8k 远高于最大赚头 $2k，连看错几次就能把多次小赚全吐回去。',
    '卖出腿行权价贪图高权利金而设得离现价太近，币价稍一反弹就被打穿，胜率骤降、还可能直奔最大亏损。',
    '把它当「无风险收租」死扛到到期——它要占保证金，且临近到期价格卡在两个行权价之间时盈亏跳动剧烈，该止盈/止损就别硬扛。',
  ],
  quickJudge: {
    use: '看不涨、上方阻力强、IV 偏高',
    avoid: '可能暴涨、IV 极低、想搏高赔率',
  },
  greeks: {
    delta: '−',
    gamma: '−',
