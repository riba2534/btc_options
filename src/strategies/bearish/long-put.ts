...
const longPut: Strategy = {
  ...
  plainSummary: '花一笔小钱赌 BTC 要跌。跌得越狠你赚得越多；要是不跌反涨，顶多把这笔小钱亏光，不会再多。',
  analogy: {
    emoji: '🎟️',
    title: '买一张"跌了就赔"的票',
    text: '花一笔小保费，买一张"BTC 跌了就赔你钱"的票：跌得越狠，赔得越多；要是不跌反涨，这张票到期作废，你最多亏掉买票的钱。和买保险不同的是，你手里不用真有 BTC 也能买这张票，纯粹押它会跌。',
  },
  pitfalls: [
    '以为"币一跌就赚钱"：必须跌破盈亏平衡点（行权价 − 权利金，约 $92k）才真盈利，小跌或慢跌照样亏权利金。',
    '贪便宜追虚值（OTM）Put：看着杠杆高，但要 BTC 暴跌一大截才回本，方向小对也常常到期归零。',
    '在暴跌恐慌、IV 飙到高位时追买：一旦价格企稳、IV 回落（Vega 收缩），即便方向看对，期权也可能不涨反跌。',
  ],
  quickJudge: {
    use: '坚定看短期大跌、能扛权利金归零',
    avoid: '横盘、慢跌、IV 高位、临近到期',
  },
  greeks: {
    delta: '−',
    gamma: '+',
