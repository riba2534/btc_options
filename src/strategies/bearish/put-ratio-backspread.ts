...
const putRatioBackspread: Strategy = {
  ...
  plainSummary: '几乎不花钱赌一场 BTC 大崩盘：卖出 1 份合约收点钱，转手买进 2 份“越跌越值钱”的合约。真暴跌了越跌赚得越多，不崩盘顶多亏点小钱；最怕的是不上不下、小跌卡在半路那个尴尬价位。',
  analogy: {
    emoji: '🌋',
    title: '用一份小保单的钱，买两张巨灾彩票',
    text: '你把一份普通保单卖给邻居、收了点保费，再拿这笔钱买了两张“灾难越大赔越多”的彩票。天下太平时你白赚那点保费差价；真来场大灾（暴跌），两张彩票一起赔、越惨赔越多。唯一难受的是只来个不大不小的麻烦（温和下跌）——你卖出的保单得赔钱，两张彩票却还没到赔付线。'
  },
  pitfalls: [
    '把它当“稳赚的崩盘险”：其实只有真正暴跌、远破下方行权价才大赚，温和下跌反而正好落在亏损最大的死谷里。',
    '临近到期才建仓：时间价值（Theta）流失飞快、Gamma 极不稳定，价格卡在死谷附近会被反复磨损。',
    '为放大收益把比例拉太大（如 1:3、1:4）：死谷的最大亏损同步放大，且需要更剧烈的暴跌才能回本。'
  ],
  quickJudge: {
    use: '预期史诗级暴跌、想低成本博黑天鹅',
    avoid: '只看温和下跌或横盘、临近到期'
  },
  greeks: {
    delta: '−',
    gamma: '+（强）',
  ...
  cryptoNote: '卖出的那条 Put 在 Deribit 要占用保证金，到期前就可能被增量强平。注意 Vega 陷阱：IV 单独飙升、现货没怎么动也会推高这条空头的 mark 价并触发追加保证金；若用币本位账户，暴跌时更会“期权浮亏 + 抵押品（BTC）缩水”双杀。务必仓位放小、留足保证金缓冲。'
};
