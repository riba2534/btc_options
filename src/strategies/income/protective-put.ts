...
const protectivePut: Strategy = {
  ...
  plainSummary: '你手里有币又怕它突然暴跌，就花一小笔钱给它买份保险。币照涨你照赚，真跌穿了保险帮你兜底，亏损停在那条线、不会越亏越多。',
  analogy: {
    emoji: '🛡️',
    title: '给资产买保险',
    text: '就像给车买保险：平时付一点保费（权利金），万一出大事故（币价暴跌）保险公司照价赔你，把损失牢牢兜在一条线以内；车没出事，保费就当花掉了。'
  },
  pitfalls: [
    '以为买了保险就稳赚——横盘或小跌时保费照付照亏，保险只在跌穿行权价后才真正兜底。',
    'Put 行权价设得离现价太远想省保费，结果要跌一大截才开始赔，关键区间根本没保到。',
    '临到期才想起续保——Put 时间价值临近到期掉得飞快，没及时滚到新到期，保护会断档。'
  ],
  quickJudge: {
    use: '持币看长期、怕短期黑天鹅',
    avoid: '舍不得保费或纯短线交易'
