...
const putButterfly: Strategy = {
  ...
  plainSummary: '赌 BTC 到期时正好停在现在这个价（$100k）附近。停得越准赚得越多；只要别大涨大跌，最多也就亏掉那一点点入场的本钱。',
  analogy: {
    emoji: '🎯',
    title: '押飞镖正中靶心',
    text: '你花一点点钱押 BTC 到期正好落在靶心（$100k）：正中红心拿大奖（最多赚 $4k），偏一点还能拿点小奖，偏太远就只亏那点入场费（$1k）。停得越准，赚得越多。'
  },
  pitfalls: [
    '以为“中性＝稳赚”：它的盈利区间很窄（约 $96k–$104k），BTC 只要稍微偏离 $100k 收益就快速回吐，跑出区间就把本钱亏光。',
    '太早建仓：利润尖塔要临近到期才变尖，离到期还远时即便价格停在 $100k 附近也几乎不赚钱。',
    '因为“风险低”就重仓乱押：单笔虽只亏净成本（$1k），但需要价格精确收敛、胜率并不高，连续押错照样会累计成大亏损。'
  ],
  quickJudge: {
    use: '笃定到期价精确停在 $100k 附近',
    avoid: '预期大涨大跌或趋势明显'
  },
  greeks: {
    delta: '≈0',
  ...
  cryptoNote: 'Deribit 期权费≈标的 0.03%/张（封顶权利金 12.5%），四条腿来回成交，手续费与点差会侵蚀本就微薄的价差收益；务必用组合单/RFQ 按净价一次性成交，别手动逐腿挂单——快市里逐腿易留下裸腿。'
};
