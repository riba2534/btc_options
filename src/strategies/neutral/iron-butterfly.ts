...
const ironButterfly: Strategy = {
  ...
  plainSummary: '赌 BTC 到期前几乎不动、就停在现价附近，这样你能稳稳收一笔钱；万一价格跑偏太多，亏损也被两翼提前封死，不会变成无底洞。',
  analogy: {
    emoji: '🎯',
    title: '押飞镖正中靶心',
    text: '就像赌飞镖正好钉在靶心（BTC 停在现价）。正中靶心拿满奖金，偏一点奖金就缩水，飞太远脱靶才亏钱——但你提前给"脱靶"买了保险，再离谱亏损也有封顶。'
  },
  pitfalls: [
    '以为"只要在区间里就稳赚"——其实盈利区间很窄（约 $94k–$106k），只有价格紧贴中心 $100k 才拿满 $6k，稍微偏离收益就大幅缩水。',
    '随手把中心定在现价就不管了——若 $100k 不在密集成交区/最大痛点附近，价格被推开的概率很高，选中心要结合点位而非图省事。',
    '临近到期还死扛——中心附近临期 Gamma 极高，价格稍一抖动盈亏就剧烈翻转，时间价值剩得不多时应提前平仓落袋。'
  ],
  quickJudge: {
    use: '笃定 BTC 到期前几乎不动、紧贴现价',
    avoid: '预计要突破、方向不明或临近到期'
  },
  greeks: {
    delta: '≈0',
    gamma: '−(强)',
  ...
  cryptoNote: '四条腿在 Deribit 每张手续费≈标的 0.03%（封顶权利金 12.5%）再加交割费，来回成交会侵蚀本就不宽的 $6k 净收益；务必用组合单/RFQ 按净价一次性成交，别手动逐腿挂单——快市里漏挂一腿就成了裸卖敞口。'
};
