...
const brokenWingCall: Strategy = {
  ...
  plainSummary: '赌 BTC 到期时基本待在 $10 万原地不大动。建仓几乎不花钱（约 $500），真要是收在 $10 万附近就能赚到约 $4500、以小博大很划算；万一大跌只小亏一点，但万一大涨反而亏得更多——这是它特意把上方安全网拉宽换来的代价。',
  analogy: {
    emoji: '🎯',
    title: '几乎免费的「押原地」彩票',
    text: '就像花极少的钱押一注「BTC 到期还停在 $10 万原地」：押中（收在 $10 万附近）就以小博大、赚一大笔；离得越远赚得越少直到亏钱。普通蝶式两边对称，这里特意把上方的「安全网」往外挪远了一点，所以建仓更便宜，但代价是真要猛涨、冲破网外时，亏的会比向下跌更多。'
  },
  pitfalls: [
    '把它当「看涨就买」——它其实是赌「不动」：BTC 大涨大跌都会亏，只有到期收在 $10 万中枢附近才赚得最多，方向看错或波动太大都不行。',
    '看到「上方亏损区离得更远」就以为上行更安全——恰恰相反，一旦真涨破 $108k，上翼亏损 −$3500 远大于下方 −$500，断翼的风险是不对称的。',
    '临近到期还在中枢附近死扛——此时 Gamma 极高、盈亏一天一个样，价格在 $10 万上下小幅波动都会让账面剧烈翻转，接近峰值就该分批止盈落袋。'
  ],
  quickJudge: {
    use: '赌到期收在 $10 万附近、波动小',
    avoid: '预期大涨大跌或中枢点位不明确'
  },
  greeks: {
    delta: '≈0',
    gamma: '−',
  ...
  cryptoNote: '四条腿、净借记仅约 $500，手续费极易吃掉薄利：Deribit 每张约名义价值 0.03%（封顶权利金 12.5%）再加交割费，四条腿来回成交一遍就可能侵蚀可观比例。务必用组合单/RFQ 一次性按净价成交，别手动逐腿挂单——快市里逐腿成交容易留下裸腿敞口。Deribit 为欧式现金交割、无提前指派与 Pin Risk，但卖出的 2× 中间腿仍占用保证金。'
};
