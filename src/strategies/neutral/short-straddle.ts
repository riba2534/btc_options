...
const shortStraddle: Strategy = {
  ...
  plainSummary: '赌 BTC 接下来就在原地附近晃、不大涨也不大跌，你现在先收两笔钱；只要它真不怎么动，这两笔钱就白赚——可一旦突然暴涨或暴跌，亏损没有上限。',
  analogy: {
    emoji: '🏦',
    title: '当一家不设赔付上限的保险公司',
    text: '你像保险公司一样，同时卖出"涨保险"和"跌保险"两张保单，当场收两笔保费。只要这段时间风平浪静、币价基本不动、没人来索赔，两笔保费全归你；可一旦出了大灾——暴涨或暴跌——赔付没有上限，可能一次把保费全赔光还倒贴老本。'
  },
  pitfalls: [
    '把"高胜率"当"低风险"：大多数时候确实能稳收双份权利金、看着很安稳，但只要一次单边暴动就可能吞掉好几个月的盈利还倒贴，这是典型的"捡钢镚被压路机碾"。',
    '裸放不对冲：卖跨式开仓时 Delta≈0，可价格一动就因负 Gamma 快速偏向一边，必须用现货/期货动态对冲或及时止损，放着不管等于赌命。',
    '临近到期还死扛：越接近到期 Gamma 越凶，价格在行权价附近一抖盈亏就剧烈翻脸；别因舍不得那点权利金而不平仓，常被最后几天的波动反杀。'
  ],
  quickJudge: {
    use: '笃定横盘震荡、IV 高位、能盯盘对冲',
    avoid: '趋势行情、重大事件前、无法盯盘止损'
  },
  greeks: {
    delta: '≈0',
    gamma: '−(强)',
  ...
  cryptoNote: '在 Deribit 卖跨式会占用保证金、到期前就可能被增量强平：即便现货没怎么动，只要 IV 单独飙升把空头 mark price 推高，也会触发追加保证金甚至强平；若用币本位保证金，暴跌时还会"浮亏 + 抵押品同步缩水"双杀。务必把仓位放小、预留充足保证金缓冲。'
};
