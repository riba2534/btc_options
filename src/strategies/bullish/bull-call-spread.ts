...
const bullCallSpread: Strategy = {
  ...
  plainSummary: '赌 BTC 会温和涨一点，但不指望它一飞冲天。你一边买入看涨、一边卖出一个更高价位的看涨来省下成本；涨到目标价就赚一笔有上限的钱，跌了顶多亏掉投入的那点小本金。',
  analogy: {
    emoji: '🏷️',
    title: '打折买的"看涨票"',
    text: '你看好 BTC 会涨，但单买一张看涨票太贵。于是你顺手把"万一暴涨"那一截收益提前卖给别人、换一笔钱来抵票价——相当于打了折买票。代价是真涨过头了，超出约定的那段跟你没关系，你只赚中间这一段差价。'
  },
  pitfalls: [
    '误把它当单买看涨、指望暴涨发大财：收益早被卖出腿封顶，真来大牛市反而懊恼"少赚一大截"。',
    '只盯着"币涨没涨"，忘了要涨过盈亏平衡点（约 $103k）才回本；涨幅盖不过净成本，照样是亏的。',
    '只平掉其中一条腿就走：剩下的裸腿风险敞口完全变了样，两条腿应一起了结，流动性差时还要留意点差与滑点。'
  ],
  quickJudge: {
    use: '温和看涨，有明确目标价位',
    avoid: '押暴涨，或横盘、方向不明'
