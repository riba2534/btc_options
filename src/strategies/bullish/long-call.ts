...
const longCall: Strategy = {
  ...
  plainSummary: '花一笔小钱赌 BTC 要涨。涨了赚很多，跌了顶多把这笔小钱亏光，不会更多。',
  analogy: {
    emoji: '🎟️',
    title: '付定金锁房价',
    text: '就像看中一套房，先付一小笔定金把价格锁住：之后房价大涨，你照样按原价买进、转手就赚差价；房价大跌，你大不了不买，只损失那笔定金，不会更亏。'
  },
  pitfalls: [
    '以为"币涨了就一定赚"——涨幅必须盖过权利金、突破盈亏平衡点才算真赚。',
    '贪便宜去买太虚值（OTM）的 Call，看着杠杆大，其实多半到期归零。',
    '临近到期才买入，时间价值（Theta）掉得飞快，稍一犹豫权利金就蒸发。'
  ],
  quickJudge: {
    use: '坚定看短期大涨、能承受归零',
    avoid: '横盘、慢牛、临近到期'
