...
const bullPutSpread: Strategy = {
  ...
  plainSummary: '你赌 BTC 短期不会大跌，建仓时先收一笔钱进口袋。只要到期时它没跌破你设的那条线，这笔钱就白赚；真跌穿了才会亏，而且最多亏多少早就被锁死了。',
  analogy: {
    emoji: '🏦',
    title: '收保费的保险公司',
    text: '你像保险公司一样收一笔保费，承诺"BTC 跌破 95k 就赔付"；同时自己再花小钱买一份 85k 的再保险。平时风平浪静，保费净赚；真出大事故，再保险帮你把赔付封顶，不至于倾家荡产。'
  },
  pitfalls: [
    '被"高胜率"冲昏头而重仓：单次最多赚 $2k、最多亏 $8k，一次跌穿就吃掉四次的利润，仓位过大会一夜亏回去。',
    '为多收权利金把卖出 Put 设得离现价太近：钱是收得多，但安全垫太薄，BTC 稍微一跌就被击穿。应把它放在支撑位下方、留足缓冲。',
    '死扛到到期：价格在卖出价附近时尾盘波动会被放大，该在赚到权利金的 50-70% 时提前平仓锁利，而不是为最后一点钱硬扛尾部风险。'
  ],
  quickJudge: {
    use: '看 BTC 不跌、想稳收权利金',
    avoid: '怕大跌、或波动率太低'
