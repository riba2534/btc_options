...
const callRatioBackspread: Strategy = {
  ...
  plainSummary: '赌 BTC 要来一波史诗级暴涨：用卖出 1 份低价看涨期权收的钱，去买 2 份高价看涨期权。真暴涨了赚到翻倍、暴跌了还能留下当初收的那点钱，最怕的是不上不下卡在半山腰。',
  analogy: {
    emoji: '🎟️',
    title: '用收来的钱买双份“暴涨彩票”',
    text: '卖出 1 张低价看涨期权先收一笔钱，转手买 2 张高价看涨期权。BTC 真来一波暴涨，两张“彩票”一起兑奖、越涨赚越多；要是只温吞地涨到半山腰就停住，你卖出的那张反而赔得最惨（这就是“死谷”）；干脆暴跌的话所有票作废，但当初收的那笔钱还揣在兜里。'
  },
  pitfalls: [
    '把它当“看涨就买”——它最怕的恰恰是温和上涨：价格涨到买入腿行权价（约 $105k）附近停住，正好砸进亏损最大的“死谷”。',
    '没算成净收入就建仓——一旦付了净权利金（净借记），暴跌时连保底的那点钱都没有、下行照样亏；务必尽量构建成零成本或净收入。',
    '临到期才进场——死谷区 Gamma 极高，到期前几天价格在 $105k 附近稍微一动，盈亏就剧烈翻转，新手扛不住。'
  ],
  quickJudge: {
    use: '坚信会史诗级暴涨、且能净收入建仓',
    avoid: '只是温和看涨、横盘或临近到期'
  },
  greeks: {
    delta: '+',
    gamma: '+(强)',
  ...
  cryptoNote: 'Deribit 上期权为欧式现金交割、无提前指派；但卖出的那条腿仍占用保证金，到期前就可能被增量强平。尤其要警惕 Vega 风险：IV 单独飙升、即便现货没动也会推高空头 mark price 触发追保；币本位账户在暴跌时还会“浮亏 + 抵押品缩水”双杀。仓位要小、保证金留足缓冲。'
};
