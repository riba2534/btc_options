...
const strap: Strategy = {
  ...
  plainSummary: '你觉得 BTC 马上要剧烈变盘、而且更可能往上冲，于是押了两份"涨了赚"加一份"跌了赚"：真涨起来收益翻倍，跌了也能赚一笔，最怕它原地不动、把你三份本金慢慢磨光。',
  analogy: {
    emoji: '🎲',
    title: '押"会爆冷，而且更看好主队"',
    text: '像赌一场球肯定会打出大比分、但你更看好主队赢：于是主队（看涨）的票买两张、客队（看跌）的票买一张。只要打得够激烈，往哪边走你都不亏，主队大胜时更是赚翻；可要是踢成沉闷平局（横盘不动），三张票一起作废。',
  },
  pitfalls: [
    '以为"只要变盘就稳赚"——价格得动得足够大、盖过三份权利金（比普通跨式还贵 50%）才真盈利，小打小闹照样亏。',
    '方向没把握也硬上 Strap——若实际向下破位，收益远不如向上突破，这时还不如用 Strip（2Put+1Call）或直接买 Put。',
    '在重大事件、IV 高位时追进——权利金被炒得很贵，就算方向猜对，事件后波动率暴跌（Vega Crush）也可能倒亏。',
  ],
  quickJudge: {
    use: '变盘在即且更可能向上突破',
    avoid: '横盘、方向不明或 IV 已高位',
  },
  greeks: {
    delta: '+',
    gamma: '+',
