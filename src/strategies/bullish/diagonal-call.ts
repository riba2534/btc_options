...
const diagonalCall: Strategy = {
    ...
    explanation: `
      ...
      <div class="grid md:grid-cols-3 gap-4 mb-6">
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
          <div class="text-xs text-green-600 font-bold mb-1">最大盈利</div>
          <div class="text-2xl font-bold text-green-700 mb-2">$11k</div>
          <p class="text-xs text-slate-600">P ≥ $110k 封顶；盈亏平衡 $99k</p>
        </div>
      ...
      <div class="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border border-blue-200 rounded-lg p-5 mb-6">
        ...
        <div class="space-y-2">
          <div class="bg-green-100 border-l-4 border-green-500 p-3 rounded">
            ...
            <p class="text-xs text-green-700 mt-1">近月归零（保留 $2k 权利金），远月 ITM 增值 +$9k；组合盈利约 $11k —— 已达价差上限（价差宽度 $15k − 净成本 $4k）</p>
          </div>
          <div class="bg-yellow-100 border-l-4 border-yellow-500 p-3 rounded">
            <p class="text-sm font-bold text-yellow-800">⚠️ 横盘 $100k (0%)</p>
            <p class="text-xs text-yellow-700 mt-1">近月完全归零（保留 $2k 权利金），远月略亏约 $1k；组合小幅盈利约 $1k</p>
          </div>
  ...
  plainSummary: '赌 BTC 慢慢往上爬：买一张管得久的"赌涨"合约打底押方向，同时把一张短期、要价更高的同类合约卖给别人收笔租金来抵成本。涨得不温不火时最划算，急涨或下跌都不理想。',
  analogy: {
    emoji: '🏠',
    title: '长线看涨 + 短期转租',
    text: '就像你看好一套房会慢慢升值，先签下长期持有权（买远月 Call）；同时把"近期要是涨太多就按高价卖给房客"的权利短租出去收租金（卖近月 Call），用租金贴补长期成本。房价温和上涨时你既赚升值又赚租金；可一旦短期暴涨、房客按约定价提走，你升值的甜头就被封顶了。',
  },
  pitfalls: [
    '以为它和普通牛市价差一样"到期一把了结"——两条腿到期日不同，近月先到期，必须主动平仓或滚动续上，放着不管会失去结构。',
    '盼着 BTC 一飞冲天——急涨会让近月被行权、收益锁死在上限，这策略要的是"慢牛"而非暴涨。',
    '在 IV 高位建仓——它净 Vega 为正，事件后 IV 回落会压低远月价值反而吃亏，应在 IV 偏低时入场。',
  ],
  quickJudge: {
    use: '温和慢涨 + IV 偏低时建仓',
    avoid: '预期急涨暴涨或 IV 高位将回落',
  },
  greeks: {
    delta: '+',
    gamma: '−',
  ...
  cryptoNote: '两腿到期日不同、Deribit 期权费约标的 0.03%/张（+交割费），多腿来回成交会侵蚀本就不大的价差收益——务必用组合单/RFQ 按净价一次成交，别逐腿手动挂单（快市易留裸腿）；卖出的近月 Call 还需占用保证金，到期后记得及时滚动续上。',
};
